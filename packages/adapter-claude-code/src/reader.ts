...
import type { ClaudeCodeEntry, ReadConversationResult } from "./types";

export async function readConversationFile(filePath: string): Promise<ReadConversationResult> {
  ...
  const errors: ReadConversationResult["errors"] = [];
